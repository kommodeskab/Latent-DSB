...
python inference.py --experiment_id=baseline --num_samples=$NUM_SAMPLES --batch_size=$BATCH_SIZE --num_steps=$NUM_STEPS --what_test=rir --folder_name=test_rir/baseline

for NUM_STEPS in 10 5 2 1
do
  ...
  python inference.py --experiment_id=130625004303 --num_samples=$NUM_SAMPLES --batch_size=$BATCH_SIZE --num_steps=$NUM_STEPS --noise_factor=0.0 --folder_name=test_rir/stft_det_$NUM_STEPS  --what_test=rir
  ...
  python inference.py --experiment_id=130625004256 --num_samples=$NUM_SAMPLES --batch_size=$BATCH_SIZE --num_steps=$NUM_STEPS --noise_factor=0.0 --folder_name=test_rir/mel_det_$NUM_STEPS   --what_test=rir

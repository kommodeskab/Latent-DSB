...
python inference.py --experiment_id=290525152024 --num_samples=$NUM_SAMPLES --batch_size=$BATCH_SIZE --save_trajectory=True --num_steps=50 --noise_factor=0.0 --folder_name=test_traj/stf  --what_test=clip

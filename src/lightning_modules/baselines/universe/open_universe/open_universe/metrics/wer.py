...
def normalize_sentence(sentence: str, wildcard: Optional[str] = None, style="whisper") -> str:
    """
...
def word_edit_distance(sentence1: List[str], sentence2: List[str], wildcard: Optional[str] = None) -> int:
    """

...
from src.lightning_modules.baselines.sgmse.sgmse import sampling
from src.lightning_modules.baselines.sgmse.sgmse.sdes import SDERegistry
from src.lightning_modules.baselines.sgmse.sgmse.backbones import BackboneRegistry
...
class ScoreModel(pl.LightningModule):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument(
            "--ema_decay", type=float, default=0.999, help="The parameter EMA decay constant (0.999 by default)"
        )
    ...
    def _loss(self, forward_out, x_t, z, t, mean, x):
        ...
        if self.loss_type == "score_matching":
            ...
            if self.loss_weighting == "1":
                ...
                losses = ((sigma**2 + self.sigma_data**2) / ((sigma * self.sigma_data) ** 2))[
                    :, None, None, None
                ] * losses
            else:

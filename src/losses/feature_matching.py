...
class HubertFeatureExtractor:
    def __init__(
        ...
        assert self.last_n_conv_layers <= self.n_conv_layers, f"last_n_conv_layers must be less than or equal to {self.n_conv_layers}"
        assert self.first_n_transformer_layers <= self.n_transformer_layers, f"first_n_transformer_layers must be less than or equal to {self.n_transformer_layers}"
